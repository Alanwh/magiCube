...
function InputTemplate (getFieldDecorator: any) {
  return(
    <>
...
function ButtonTemplate (getFieldDecorator: any) {
  return(
    <>
...
function SelectTemplate (getFieldDecorator: any) {
  return(
    <>
      <Form.Item label='key值'>
        {getFieldDecorator('key', {
...
function TimeTemplate (getFieldDecorator: any) {
  return(
    <>
